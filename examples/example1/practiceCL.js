...
if ((currentState == 0 || currentState == 1) && order[0] == "con") {
  window.close();
}
else if ((currentState == 2 || currentState == 3) && order[1] == "con") {
  window.close();
}
...
function taskDone() {
  ...
  pracCLdata = [pracOrder, rt, responses, correctResp];
  dataObj["pracCLdata"] = pracCLdata;
